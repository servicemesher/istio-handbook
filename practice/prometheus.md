...
图片来源：[Prometheus 官方文档](https://prometheus.io/docs/introduction/overview/)
...
此外，我们可以通过修改 Prometheus 的 ConfigMap 对其配置进行如下修改：
...
![Prometheus 区间数据查询示例](../images/prometheus-graph-query.png)
...
![Grafana 主页](../images/prometheus-grafana-home.png)
